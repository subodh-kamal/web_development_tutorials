...
Every module has its own object. For example, math.js is a module and index.js is another module; each has its own separate module object in the local variable section.
